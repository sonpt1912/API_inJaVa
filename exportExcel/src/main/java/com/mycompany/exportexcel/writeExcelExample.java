 ...
 */
package com.mycompany.exportexcel;
...
public class writeExcelExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        books.add(new Book(1, "hello", 2, 2.1, 2.1));
        final String excelFilePath = "D:/demo/books.xlsx";
    ...
    private static List<Book> getBooks() {
        ...
        Book book;
        for (int i = 1; i <= 5; i++) {
            book = new Book(i, "Book " + i, i * 2, i * 1000.1, 0.1);
            listBook.add(book);
        }
        return listBook;
    }
